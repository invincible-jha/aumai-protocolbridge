# Agent Instructions for Protocolbridge

## Project Context
Protocolbridge is an open source Translate between agent communication protocols.

## Repository Layout
- `src/aumai_protocolbridge/` — package source
